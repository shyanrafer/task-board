...
function createTaskCard() {
  ...
  addTaskButton.addEventListener('click', function() {
    const taskDescription = window.prompt("Enter your task here", "Task description");
    
    if (taskDescription === "") {
      displayMessage('text', 'Form cannot be blank');
    } else {
      console.log("Task created: " + taskDescription);
      // Here you can create a task card with the entered task description
    }
  });
}
